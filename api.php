...
Route::post('/contact', 'api\ChaletList_Controller@view_contact');

Route::post('/my_reservation', 'api\Reservation_Controller@reservation_details');
Route::post('/guestuser', 'api\UserAuth_Controller@guestUser');

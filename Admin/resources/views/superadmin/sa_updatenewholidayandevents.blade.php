...
@section('title', "Update Holidays and Events")
@section('content')
...
<div class="" style="min-height:614px;">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h1>Update Holidays and Events</h1>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content2">
                    <form class="form-horizontal form-label-left" method="POST" action="{{ url('updateholidayandevent') }}" enctype="multipart/form-data" id="myform">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="holidayid" value="{{$holidaydetails->id}}">
                        <div class="clearfix"></div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Event Name</label>
                            <div class="col-md-9 col-sm-4 col-xs-12">
                                <input type="text" id="event_name" name="event_name" value="{{$holidaydetails->event_name}}" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                                       ...
                                       $min= date('Y-m-d\TH:i', strtotime($cdate));
                                        ?>
                                            <!-- <div class='input-group date' id='datetimepicker6'> -->
                                                <input required="required" value="{{ date('Y-m-d\TH:i', strtotime($holidaydetails->check_in)) }}" min="<?php echo $min; ?>" name="event_checkin" style="width: 237px;" type='datetime-local' class="form-control" />
                                        ...
                                        <?php  $c_date=date("Y-m-d", strtotime('tomorrow'));
                                         $mini= date('Y-m-d\TH:i', strtotime($c_date)); ?>
                                            <!-- <div class='input-group date' id='datetimepicker7'> -->
                                                <input required="required" min="<?php echo $mini; ?>" style="width: 237px;" value="{{ date('Y-m-d\TH:i', strtotime($holidaydetails->check_out)) }}" name="event_checkout" type='datetime-local' class="form-control" />
                                                <!-- <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span> -->
                                                </span>
                                            <!-- </div> -->
                                        </div>

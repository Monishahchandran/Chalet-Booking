...
@if($pages=='paid')
@section('title', "All Paid of User")
@elseif($pages=='unpaid')
@section('title', "All UnPaid of User")
@elseif($pages=='deposit')
@section('title', "All Remaining of User")
@endif
@section('content')
...
<div>
    ...
    <div class="x_panel">
        <div class="x_title">
            @if($pages=='paid')
            <h1>All <b style="color: limegreen">Paid</b> of User </h1>
            @elseif($pages=='unpaid')
            <h1>All <b style="color: orangered">UnPaid</b> of User </h1>
            @elseif($pages=='deposit')
            <h1>All <b style="color: #FF9933">Remaining</b> of User </h1>
            @endif
        </div>
        <div class="x_content">

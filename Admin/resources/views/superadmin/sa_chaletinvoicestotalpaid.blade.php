...
@section('title', "All Paid of Chalet's")
@section('content')
<!-- page content -->
...
<div>
    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            ...
            <h1>All <b style="color: limegreen">Paid</b> of Chalet's </h1>
        </div>
        ...
        <div class="x_content">
            ...
            <div>
                <table id="datatable-responsive" data-order="[[ 1, &quot;desc&quot; ]]" class="table table-striped table-bordered dt-responsive nowrap jambo_table" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th width="1%">No.</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                    <a class="btn btn-danger btn-xs" href="{{ url('/cancelreservation') }}/<?php echo $rdetails->rid; ?>/<?php echo 'totalpaidinvoice'; ?>">Cancel Reservation</a>

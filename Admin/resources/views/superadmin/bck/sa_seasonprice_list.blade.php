                ...
                <table border="0" width="100%" cellpadding="5" cellspacing="0">
                    <tr>
                        ...
                        <td width="80%" valign="top">
                            ...
                            <h3>:<input type="text" style="border: transparent;" name="season_start" id="season_start" value="@if(!empty($seasondate)){{$seasondate->season_start}}@endif" placeholder="01/05/2021"/></h3>
                            <h3>:<input type="text" name="season_end" id="season_end" style="border: transparent;" value="@if(!empty($seasondate)){{$seasondate->season_end}}@endif" placeholder="30/09/2021"/> </h3>
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap jambo_table" cellspacing="0" width="100%">
                ...
                <?php $image = (new \App\Helper)->get_chalet_image($cdetails->cid); ?>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="week_seasonprice<?php echo $loop->iteration;?>" value="{{$cdetails->week_seasonprice}}" style="height: 30px;" size="6" onchange="weekFunction('<?php echo $cdetails->cid; ?>','week_seasonprice<?php echo $loop->iteration;?>');" maxlength="4"> KD
                        </td>
                        <td>
                            <input type="text" id="weekend_seasonprice<?php echo $loop->iteration;?>" value="{{$cdetails->weekend_seasonprice}}" style="height: 30px;"  onchange="weekendFunction('<?php echo $cdetails->cid; ?>','weekend_seasonprice<?php echo $loop->iteration;?>');" size="6" maxlength="4"> KD
                        </td>
                        <td>
                            <input type="text" id="weekdays_seasonprice<?php echo $loop->iteration;?>" value="{{$cdetails->weekdays_seasonprice}}"  onchange="weekdaysFunction('<?php echo $cdetails->cid; ?>','weekdays_seasonprice<?php echo $loop->iteration;?>');" style="height: 30px;" size="6" maxlength="4"> KD
                        </td>
                        <td align="center">
                            @if($cdetails->season_status==1)
                            <label><input type="checkbox" id="myCheck" onclick="mystatusFunction('<?php echo $cdetails->cid; ?>')" class="js-switch" name="seasonal_status" checked> </label>
                            @endif
                            @if($cdetails->season_status==0)
                            <label><input type="checkbox" id="myCheck" onclick="mystatusFunction('<?php echo $cdetails->cid; ?>')" class="js-switch" name="seasonal_status"> </label>
                            @endif
                        </td>
                    </tr>
                    @endforeach

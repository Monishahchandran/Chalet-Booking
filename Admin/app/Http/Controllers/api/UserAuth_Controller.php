  ...
  public function userRegistration(Request $request)
  {
    ...
    // DB::table('users')->insert($data);
      ...
      $id = DB::table('tb_users')->insertGetId(
        ['first_name' => $data['first_name'], 'last_name' => $data['last_name'], 'email' => $data['email'], 'password' => $data['password'], 'phone' => $data['phone'], 'dob' => $date, 'gender' => $data['gender'], 'device_token' => $data['device_token'], 'country' => $data['country'],'country_code'=>$data['country_code']]
      );
...
public function editProfile(Request $request){
  ...
  $data['country_code']=$request->country_code;
   $affected = DB::table('tb_users')
              ->where('id', $request->id)
              ->update(['first_name' => $request->first_name,'last_name'=>$request->last_name,'email'=>$request->email,'phone'=>$request->phone,'gender'=>$request->gender,'country_code'=>$request->country_code]);
